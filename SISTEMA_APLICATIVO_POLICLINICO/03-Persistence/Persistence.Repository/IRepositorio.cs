...
namespace Persistence.Repository
{
    public interface IRepository<T>
    {
        ...
        /// </summary>
        /// <param name="entity"></param>
        IQueryable<T> SelectQuery(string query, params object[] Parametros);
        int ExecuteSqlCommand(string query, params object[] Parametros);

        /// <summary>
        /// Ejecuta un query personalizado y espera un retorno a cambio
        /// </summary>
        /// <param name="entity"></param>
        IQueryable<I> ExecuteSqlCommand<I>(string query, params object[] Parametros) where I : class;
        #endregion
    }
}
