...
namespace PoliclinicoWeb.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            var edtUrs = new EditUserViewModel
            {
                Id = user.Id,
                Email = user.Email,
        ...
        public async Task<ActionResult> Edit(EditUserViewModel editUserViewModel, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
                ...
                IList<string> userRoles =  user.Roles.Select(r=>r.RoleId).ToList();
