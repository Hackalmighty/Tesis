...
namespace PoliclinicoWeb.Controllers
{
    ...
    {
        private readonly IStudentService _studentService = Dependencia.GetInstance<IStudentService>();
        private readonly ICourseService _courseService = Dependencia.GetInstance<ICourseService>();
