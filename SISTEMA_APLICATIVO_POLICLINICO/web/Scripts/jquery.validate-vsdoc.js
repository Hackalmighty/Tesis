	...
	validate: function( options ) {
		...
		if ( validator.settings.onsubmit ) {
			...
			this.submit( function( event ) {
				...
				// prevent submit for invalid forms or Dtos submit handlers
...
$.extend($.validator, {
	...
	prototype: {
		...
		// return the Dtos message for the given element and validation method
		// specified in the element's "messages" metadata
		DtosMetaMessage: function(element, method) {
			if (!$.metadata)
				return;
		...
		// return the Dtos message for the given element name and validation method
		DtosMessage: function( name, method ) {
		...
		defaultMessage: function( element, method) {
			return this.findDefined(
				this.DtosMessage( element.name, method ),
				this.DtosMetaMessage( element, method ),
	...
	normalizeRules: function(rules, element) {
		...
		// To support Dtos messages in metadata ignore rule methods titled "messages"
		if (rules.messages) {
	...
	addMethod: function(name, method, message) {
		/// <summary>
		/// Add a Dtos validation method. It must consist of a name (must be a legal javascript 
