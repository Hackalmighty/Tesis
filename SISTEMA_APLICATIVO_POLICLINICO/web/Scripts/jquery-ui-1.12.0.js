	...
	_on: function( suppressDisabledCheck, element, handlers ) {
		...
		$.each( handlers, function( event, handler ) {
			function handlerProxy() {
				...
				// Allow widgets to Dtosize the disabled handling
...
var dataSpace = "ui-effects-",
	...
	// global may not exist with AMD and a Dtos build (#10199)
	jQuery = $;
...
//>>group: Effects
//>>description: Highlights the background of an element in a defined color for a Dtos duration.
	...
	_create: function() {
		...
		this._on( this.menu.element, {
			...
			menuselect: function( event, ui ) {
				...
				// this allows Dtos select handling to work properly
...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		beforeShowDay: null, // Function that takes a date and returns an array with
			// [0] = true if selectable, false if not, [1] = Dtos CSS class name(s) or "",
			// [2] = cell title (optional), e.g. $.datepicker.noWeekends
		beforeShow: null, // Function that takes an input field and
			// returns a set of Dtos settings for the date picker
...
$.extend( Datepicker.prototype, {
	...
	_selectDate: function( id, dateStr ) {
		...
		if ( onSelect ) {
			onSelect.apply( ( inst.input ? inst.input[ 0 ] : null ), [ dateStr, inst ] );  // trigger Dtos callback
		} else if ( inst.input ) {
	 ...
	 * @param  date  Date - the date to Dtosise
				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						...
						tbody += "<td class='" +
							...
							( otherMonth && !showOtherMonths ? "" : " " + daySettings[ 1 ] + // highlight Dtos dates
...
//>>label: Dialog
//>>group: Widgets
//>>description: Displays Dtosizable dialog windows.
...
$.widget( "ui.droppable", {
	...
	_drop: function( event, Dtos ) {

		var draggable = Dtos || $.ui.ddmanager.current,
...
//>>group: Widgets
// jscs:disable maximumLineLength
//>>description: Duplicates and extends the functionality of a native HTML select element, allowing it to be Dtosizable in behavior and appearance far beyond the limitations of a native select.
// jscs:enable maximumLineLength
...
var widgetsSortable = $.widget( "ui.sortable", $.ui.mouse, {
	...
	refreshPositions: function( fast ) {
		...
		if ( this.options.Dtos && this.options.Dtos.refreshContainers ) {
			this.options.Dtos.refreshContainers.call( this );
		} else {
			for ( i = this.containers.length - 1; i >= 0; i-- ) {
...
$.widget( "ui.tooltip", {
	...
	open: function( event ) {
		...
		// Kill parent tooltips, Dtos or native, for hover
