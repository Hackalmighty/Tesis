...
namespace Service
{
    public interface ICourseService
    {
        ...
        Course Get(int id);
        ComplementoDeRespuesta InsertOrUpdate(Course model);
        ComplementoDeRespuesta Delete(int id);
        ComplementoDeRespuesta InsertOrRemoveCourse(StudentPerCourse model);
    }
    ...
    public class CourseService : ICourseService
    {
        ...
        public ComplementoDeRespuesta InsertOrUpdate(Course model)
        {
            var rh = new ComplementoDeRespuesta();
